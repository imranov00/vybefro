...
export default function RegisterScreen() {
  ...
  const handleConfirmDate = () => {
    ...
    // Burç hesapla
    const zodiacSign = calculateZodiacSign(newDate);
  ...
  const getZodiacIcon = (sign: string) => {
    switch (sign) {
      case 'Koç': return '♈️';
      case 'Boğa': return '♉️';
      case 'İkizler': return '♊️';
      case 'Yengeç': return '♋️';
      case 'Aslan': return '♌️';
      case 'Başak': return '♍️';
      case 'Terazi': return '♎️';
      case 'Akrep': return '♏️';
      case 'Yay': return '♐️';
      case 'Oğlak': return '♑️';
      case 'Kova': return '♒️';
    ...
    >
      ...
      >
        ...
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerSubText}>Burç Modu</Text>
        </View>
        ...
        onPress={() => {
          try {
            if (isAndroid) {
              ...
              setTimeout(() => {
                router.replace('/(auth)/register-music');
              }, 50);
            }
          } catch (error) {
            ...
            <View style={styles.zodiacContainer}>
              <View style={styles.zodiacContent}>
                <Text style={styles.zodiacIcon}>
                  {getZodiacIcon(calculatedZodiacSign)}
                </Text>
                <Text style={styles.zodiacText}>
                  Burcunuz: {calculatedZodiacSign}
                </Text>
              </View>
            </View>
          )}
