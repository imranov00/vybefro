...
export default function AstrologyMatchesScreen() {
  ...
  const [activeTab, setActiveTab] = useState<'matches' | 'suggestions' | 'liked'>('matches');
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Ionicons 
            name="heart" 
            size={20} 
            color={activeTab === 'liked' ? '#FFFFFF' : 'rgba(255,255,255,0.6)'} 
          />
      ...
      <Animated.View style={[styles.content, animatedStyle]}>
        ...
        {activeTab === 'liked' && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>Henüz kimseyi beğenmedin</Text>
            <Text style={styles.emptySubtitle}>
              Burç eşleşmesi sayfasından potansiyel eşleri keşfet
            </Text>
          </View>
        )}
      </Animated.View>
